...
int main()
{
	...
	setcolor(GREEN);
	 ...
	 // P1 = (80, 80), P2 = (150, 150)
	 line(80, 80, 150, 150);
	 CohenSutherlandLineClipAndDraw(80, 80, 150, 150);
	 // Third Line segment
	 // P1 = (290, 310), P2 = (320, 500)
	 setcolor(GREEN);
	 line(290, 310, 320, 500);
	 CohenSutherlandLineClipAndDraw(290, 310, 320, 500);
	 
	 // Fourth Line segment
	 // P1 = (450, 450), P2 = (500, 500)
	 setcolor(GREEN);
	 line(450, 450, 500, 500);
	 CohenSutherlandLineClipAndDraw(450, 450, 500, 500);
